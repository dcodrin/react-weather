...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MainNav = __webpack_require__(229);
	...
	var _Examples = __webpack_require__(253);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WEATHER_API_KEY = "380170ad0ee01fe048ecc89e68a8b13d";
	var ROOT_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=' + WEATHER_API_KEY + '&units=metric';
	...
	var Weather = function (_React$Component) {
	    ...
	    function Weather() {
	        ...
	        _this.handleCitySelect = _this.handleCitySelect.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(Weather, [{
	        ...
	        value: function handleCitySelect(city) {
	            ...
	            _axios2.default.get(ROOT_URL + '&q=' + encodeURIComponent(city)).then(function (res) {
	
	                if (res.data.cod !== '404') {
	                    _this2.setState({ city: res.data.name, temperature: res.data.main.temp, cod: res.data.cod });
	                } else {
	                    _this2.setState({ cod: res.data.cod });
	                }
